...
class ExampleIrregularityBasicContentView: ExampleBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        iconColor = UIColor.init(white: 255.0 / 255.0, alpha: 0.50)
        highlightIconColor = UIColor.init(red: 255.0/255.0, green: 255.0/255.0, blue: 255.0/255.0, alpha: 0.8)
        backdropColor = UIColor.init(red: 255.0/255.0, green: 255.0/255.0, blue: 255.0/255.0, alpha: 0.1)
        highlightBackdropColor = UIColor.init(red: 255.0/255.0, green: 255.0/255.0, blue: 255.0/255.0, alpha: 0.1)
    }
