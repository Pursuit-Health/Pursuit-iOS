...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ClosureKit/ClosureKit.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/PIDatePicker/PIDatePicker.framework"
  install_framework "$BUILT_PRODUCTS_DIR/RHDisplayLinkStepper/RHDisplayLinkStepper.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SDWebImage/SDWebImage.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SHTextFieldBlocks/SHTextFieldBlocks.framework"
