...
class SameMessageImageCell: UITableViewCell {
    ...
    func setup() {
        ...
        self.messageImageView.layer.mask = shapeLayer
    ...
    func createBezierPath() -> UIBezierPath {
        ...
        let width = messageImageView.bounds.maxX
        let height = messageImageView.bounds.maxY
        
        let path = UIBezierPath()
        
        
        path.move(to: CGPoint(x: messageImageView.bounds.minX, y: messageImageView.bounds.minY))
