...
class DezappLabel: UILabel {
    ...
    func updateAttributedTextWithColor(color: UIColor) {
    ...
    func updateAttributedTextWithColorAtRange(color: UIColor, range: NSRange) {
        guard let attributedText = attributedText else {
            return
        }
    ...
    func updateAttributedTextWithString(string: String) {
        guard let attributedText = attributedText else {
            return
        }
    ...
    func updateAttributedPlaceholderWithString(string : String){
        guard let attributedText = attributedText else {
            return
        }
    ...
    func updateAttributedTextTextAlignment(textAlignment: NSTextAlignment) {
        guard let attributedText = attributedText else {
            return
        }
