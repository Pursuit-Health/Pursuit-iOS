...
- (void)changePlaceHolderText:(NSString *)placeHolder {
    [self setPlaceHolder:placeHolder];
}
    
- (void)changePlaceHolderTextColor:(UIColor *)placeHolderTextColor
    {
        [self setPlaceHolderTextColor:placeHolderTextColor];
    }
